/**
 * File: inout_aper.c
 * Various input/output related routines.
 *
          ...
          if (b->awidth > 0.0)
            {
              ...
              sprintf (awidth,
                  "     AWIDTH%i%c   %.3f \t\t\t\t\t\t;%s Maximum Object Width.",
                  oid, BEAM (i), b->awidth, label);

              /* Output BWIDTH width of object info */
              sprintf (bwidth,
                  "     BWIDTH%i%c   %.3f \t\t\t\t\t\t;%s Minimum Object Width.",
                  oid, BEAM (i), b->bwidth, label);

              /* Output AORIENT angle of object info */
              sprintf (aorient,
                  "     AORIENT%i%c  %.3f \t\t\t\t\t\t;%s Orientation of Max. Object Width.",

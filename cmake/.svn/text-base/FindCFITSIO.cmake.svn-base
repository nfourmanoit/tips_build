...
if(CFITSIO_INCLUDE_DIRS AND CFITSIO_LIBRARIES)
  ...
  if(CFITSIO_USE_STATIC AND CFITSIO_STATIC_LIBRARIES)
    set(CFITSIO_LIBRARIES ${CFITSIO_STATIC_LIBRARIES})
  else(CFITSIO_USE_STATIC AND CFITSIO_STATIC_LIBRARIES)
    set(CFITSIO_LIBRARIES ${CFITSIO_SHARED_LIBRARIES})
  endif(CFITSIO_USE_STATIC AND CFITSIO_STATIC_LIBRARIES)
